            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="notasDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fa fa-envelope-open-text"></i> Notas Recebidas
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="notasDropdown">
                        <li><a class="dropdown-item" href="../notas/nb_recebida.php" target="content-frame"><i class="fa fa-inbox"></i> Receber notas</a></li>
                        <li><a class="dropdown-item" href="../notas/nota_recebida.php" target="content-frame"><i class="fa fa-inbox"></i> Notas recebidas</a></li>
                        <li><a class="dropdown-item" href="#" target="content-frame"><i class="fa fa-paper-plane"></i> NB Enviadas</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="boletimDropdown">
                        ...
                        <li><a class="dropdown-item" href="../materia_boletim/add_materia_boletim.php" target="content-frame"> <i class="fa fa-plus-circle"></i> Add nota em boletim</a> </li>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="boletimDropdown">
                        <li><a class="dropdown-item" href="../boletins.php" target="content-frame"><i class="fa fa-plus-circle"></i> Boletins</a></li>
                        <li><a class="dropdown-item" href="#" target="content-frame"> <i class="fa fa-plus-circle"></i> Ficha de alterações</a> </li>
                    </ul>
                </li>
                
                
                <li class="nav-item">
                    <a class="nav-link" href="#" target="content-frame"><i class="fa fa-cogs"></i> Administração</a>
                </li>
            </ul>
        </div>
    </div>
